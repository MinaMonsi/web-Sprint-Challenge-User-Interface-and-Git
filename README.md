...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
   ...
   Semantic HTML is the bare bones or the skeleton form of a web page.

2. Name two big differences between `display: block;` and `display: inline;`.

The difference is that 'display: inline;' allows elements to sit next to each other and respects the margins. 'Display; block;' does not.

3. What are the 4 areas of the box model?

The four areas are the content edge, padding edge, border edge, and margin edge.
